...
*/
	...
	public String obtenerTextoDeArchivo(String rutaArchivo){
		...
		try {
			lector.borraDocumentoTXT(rutaArchivo);
		} catch (Exception e) {
			System.out.println("No se puede BORRAR el archivo :"+rutaArchivo);
			System.out.println("Tal vez no existe");
		}
