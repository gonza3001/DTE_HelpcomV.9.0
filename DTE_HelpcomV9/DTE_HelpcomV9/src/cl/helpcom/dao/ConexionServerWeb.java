 ...
 */
public class ConexionServerWeb {
    ...
    public ConexionServerWeb() throws ClassNotFoundException, SQLException, IOException {
...
//        password = propiedades.getProperty("PASSWORD_SERVER").toString();
		...
		server = "jdbc:mysql://190.13.136.238:63306";
		bd = "db_portal_dte";
		user = "helpcom_dte";
		password = "niclabs56dte33";
