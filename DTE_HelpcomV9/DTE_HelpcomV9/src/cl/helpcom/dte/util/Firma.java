...
public class Firma {
	...
	public String firmarDTE(ArrayList<String> datosEmp,String rutReceptor,String xml_firmado,Integer tdo_id,Integer doc_folio,Integer emp_id,String passCert,String fchEmision) throws IOException {
		...
		String envioFirmadoTercero = rutaRaiz+"/"+emp_id+"/" +propiedades.getProperty("RUTA_EMPAQUETADO_TERCERO").toString();
		String nroResol="";
		String fchResol="";
		...
		try {
			...
			try {
				...
				envioTercero.generarEnvio(datosEmp,rutReceptor ,archivoFirmado+"/"+tipoDTE+folio+".xml",tipoDTE+folio+".xml","ConDS");
				...
				String contenido="";
				contenido=dteText.obtenerTextoDeArchivo(envioFirmadoTercero+"/"+tipoDTE+folio+".xml");
				dteText.escribirArchivo(envioFirmadoTercero+"/"+tipoDTE+folio+".xml", contenido);
