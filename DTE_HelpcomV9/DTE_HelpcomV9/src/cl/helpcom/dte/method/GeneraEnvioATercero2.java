...
import cl.helpcom.dao.ConexionSqlEnvioTercero;
...
public class GeneraEnvioATercero2 {
...
//		java.util.Arrays.sort(children);
		...
		ConexionSqlEnvioTercero conexionSqlGeneraEnvio = new ConexionSqlEnvioTercero();
