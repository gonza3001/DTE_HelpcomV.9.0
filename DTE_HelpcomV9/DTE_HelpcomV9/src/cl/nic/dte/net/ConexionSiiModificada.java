...
public class ConexionSiiModificada {
	 ...
	 * @throws XmlException
	 */
	public RESPUESTADocument getEstadoDTEProduccion(String rutConsultante,String token,ArrayList<String> datosDTE) throws UnsupportedOperationException,
			SOAPException, MalformedURLException, XmlException {
		String urlSolicitud = Utilities.netLabels.getString("URL_CONSULTA_ESTADO_DTE_PRODUCCION");
		return getEstadoDTE(rutConsultante, token, urlSolicitud,datosDTE);
	}
	 ...
	 * @throws XmlException
	 */
//	public QueryEstDte getEstadoEnSII(String rutConsultante,String token) throws UnsupportedOperationException,
//		SOAPException, MalformedURLException, XmlException {
//		String urlSolicitud = Utilities.netLabels.getString("https://maullin.sii.cl/DTEWS/QueryEstDte.jws?WSDL");
//		return getEstadoSII(rutConsultante, token, urlSolicitud);
//}
...
//		return getEstadoDTE(rutConsultante, token, urlSolicitud);
//	}

	@SuppressWarnings("unchecked")
	private RESPUESTADocument getEstadoDTE(String rutConsultante,String token, String urlSolicitud,ArrayList<String> datosDTE)throws UnsupportedOperationException, SOAPException,MalformedURLException, XmlException {

		String rutEmisor = datosDTE.get(0);
		String rutReceptor = datosDTE.get(1);
		Integer tipoDTE = Integer.valueOf(datosDTE.get(2));
		long folioDTE = Long.valueOf(datosDTE.get(3));
		String fechaEmision = datosDTE.get(4);
		long montoTotal = Long.valueOf(datosDTE.get(5));
	...
	private RESPUESTADocument getEstadoSII(String rutConsultante,String token, String urlSolicitud) throws UnsupportedOperationException, SOAPException,MalformedURLException, XmlException {

		String rutEmisor = "79716930-7";
		String rutReceptor = "77640520-5";
		Integer tipoDTE = 33;
		long folioDTE = 188305;
//		String fechaEmision = "2016-07-20";
		String fechaEmision = "09-03-2017";
		long montoTotal = 105000;
