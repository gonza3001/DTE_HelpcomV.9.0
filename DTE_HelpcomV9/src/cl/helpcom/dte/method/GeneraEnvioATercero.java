...
public class GeneraEnvioATercero {
	...
	public void generarEnvio(ArrayList<String> datosEmp,String rutReceptor,String rutaFirmado,String nombreArchivo) throws IOException, NoSuchAlgorithmException, CertificateException, KeyStoreException, UnrecoverableKeyException, ParseException, XmlException, ClassNotFoundException, SQLException {
...
//		String directorioFirmado =rutaRaiz+"/"+emp_id+"/" +propiedades.getProperty("RUTA_RESULTADO_DTE_FIRMADO").toString()+"/";
//		String directorioFirmado ="/usr/local/F_E/DTE/1/Firmados/2016/7/";
		//Directorio donde quedarán los documentos empaquetados
		String envioFirmado = rutaRaiz+"/"+emp_id+"/" +propiedades.getProperty("RUTA_EMPAQUETADO_TERCERO").toString();
...
//		// leer directorio
//		File dir = new File(directorioFirmado);
